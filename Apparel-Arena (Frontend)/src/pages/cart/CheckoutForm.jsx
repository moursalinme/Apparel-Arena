...
const CheckoutForm = () => {
    ...
    return (
        <div>
            <div className=" bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
                <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style={{"maxWidth": "600px"}}>
                    ...
                    <div className="mb-3 flex -mx-2">
                        <div className="px-2">
                            <label htmlFor="type1" className="flex items-center cursor-pointer">
                                <input type="radio" className="htmlForm-radio h-5 w-5 text-indigo-500" name="type" id="type1" checked />
                    ...
                    <div className="mb-3 -mx-2 flex items-end">
                        <div className="px-2 w-1/2">
                            ...
                            <div>
                                <select className="htmlForm-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer">
                    ...
                    <div>
                        <button onClick={()=>handlePay()} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"><i className="mdi mdi-lock-outline mr-1"></i> PAY NOW</button>
                    </div>
                </div>
            </div>
            ...
            {/* <div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
                <div>
                    <a title="Buy me a beer" rel="noreferrer" href="https://www.buymeacoffee.com/scottwindon" target="_blank" className="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transhtmlForm hover:scale-110 hover:rotate-12">
